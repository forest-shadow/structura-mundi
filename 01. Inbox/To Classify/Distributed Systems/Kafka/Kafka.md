...
- На текущем этапе не нужно вводить дополнительный уровень вроде `Kafka Internals`, пока внутри ветки нет устойчивого корпуса соседних заметок про replication, controllers и rebalancing.
