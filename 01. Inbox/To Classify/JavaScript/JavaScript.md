...
Обзорная заметка верхнего уровня для ветки `JavaScript` как языка программирования и связанных с ним фундаментальных моделей, которые требуют собственных подветок в базе знаний.
...
- [ ] Проверить, нужна ли позже отдельная ветка про execution model
- [ ] Проверить `related`
- [ ] Проверить `aliases`
- [ ] Проверить `tags`
